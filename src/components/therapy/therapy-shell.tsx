...
const NAV = [
  { href: "/therapy", label: "Therapy queue", icon: "💆" },
] as const;
  ...
  return (
    <div className="min-h-screen flex bg-[#0c0f15] text-[#e8edf4]">
      <aside className="w-64 shrink-0 flex flex-col border-r border-[#c9a35c]/25 bg-[#0c0f15]">
        <Link href="/therapy" className="flex items-center gap-3 px-4 py-4">
          ...
          <div>
            ...
            <p className="lux-gold-text text-sm font-serif font-semibold tracking-wide">Therapy Portal</p>
          </div>
        </Link>
        ...
        <div className="p-4 text-[10px] text-[#c8d2e0]/50">
          ...
          <p className="mt-1">Therapist access only — no billing</p>
          <form action="/auth/signout" method="post" className="mt-3">
            <button
              type="submit"
              className="px-3 py-1.5 text-[11px] font-semibold border border-[#DB3EB1]/55 text-[#e878c8] rounded-md hover:bg-[#DB3EB1]/12 transition-all"
            >
              Sign out
            </button>
          </form>
