  ...
  return (
    <div className="px-6 py-4 max-w-6xl mx-auto">
        ...
        <div className="mb-4 flex flex-wrap items-center gap-x-6 gap-y-2 rounded-lg border border-gold/30 bg-gold-soft/40 px-4 py-2.5 text-xs">
          ...
          <Link
            href={`/patients/${patient.id}?tab=billing`}
            className="ml-auto text-neon-pink hover:underline font-medium"
          >
            Billing & claims → patient&apos;s Billing tab
          </Link>
          <Link
            href={`/patients/${patient.id}?tab=files`}
