...
-- 1. Open THIS file in Cursor (not the path — the file contents)
...
--
-- RIGHT: everything below this banner, starting with "alter table public.profiles"
-- =============================================================================

-- Kiosk role + Pro Injury 8-page intake packet tables
