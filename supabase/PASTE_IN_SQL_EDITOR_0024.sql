...
-- Seeds the remaining Therapy SOAP Note procedure codes for auto-billing.
-- Codes already present keep their fees; new ones start at 0.00 —
-- set real rates before billing them.
